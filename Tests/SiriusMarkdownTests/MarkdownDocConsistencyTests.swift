...
func bugfixLogHistoricalEntriesPreserved() throws {
    ...
    #expect(bugfix.contains("## Resolved in 0.6.14"), "Bugfix log should record the current release")
...
func releaseCheckTestFloorMatchesCurrentCount() throws {
    ...
    #expect(
        releaseCheck.contains("MINIMUM_TEST_COUNT=875"),
        "release-check.sh test floor should be 875"
    )
}
