...
for required_test in \
  ...
  "SiriusMarkdownSwiftUITests.ProductHighlightJavaScriptRuntimeKeepsBridgeValuesAliveAcrossForcedGarbageCollection()" \
  "SiriusMarkdownSwiftUITests.ProductMermaidJavaScriptRuntimeKeepsBridgeValuesAliveAcrossForcedGarbageCollection()" \
