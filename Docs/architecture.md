...
- stable streaming region revisions must survive mutable-tail publications, and genuine AppKit-hosted rapid publication must avoid synchronous constraint recursion;
