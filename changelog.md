...
- Expanded Swift coverage to 127 runner-counted tests plus parameterized edge cases for streaming equivalence, stable block IDs, source byte/line maps, conservative and incremental boundary scanning, block and inline classification, structured AST conversion, policy handling, cache eviction, diagnostics, renderer behavior, prepared snapshots, source-backed copy, SwiftUI snapshot rendering, umbrella import ergonomics, Pretext fixture drift, and deterministic inline layout.
