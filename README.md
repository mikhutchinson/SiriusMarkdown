...
```swift
dependencies: [
    .package(url: "https://github.com/mikhutchinson/SiriusMarkdown.git", from: "0.5.1")
],
targets: [
    .target(
        name: "YourApp",
...
`0.5.1` is ready to publish only when:
...
- the release commit is tagged as `0.5.1` and pushed with tags.
