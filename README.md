...
```swift
dependencies: [
    .package(url: "https://github.com/mikhutchinson/SiriusMarkdown.git", from: "0.3.2")
],
targets: [
    .target(
        name: "YourApp",
...
`0.3.2` is ready to publish only when:
...
- the release commit is tagged as `0.3.2` and pushed with tags.
