...
```swift
dependencies: [
    .package(url: "https://github.com/mikhutchinson/SiriusMarkdown.git", from: "0.2.0")
],
targets: [
    .target(
        name: "YourApp",
...
`v0.2.0` is ready to publish only when:
...
- the release commit is tagged as `v0.2.0` and pushed with tags.
